...
with col1:
    ...
    if st.button("ROI 분석 실행하기", key="go_roi", use_container_width=True, type="primary"):
        st.switch_page("pages/roi_v0.3.py")
...
with col2:
    ...
    """, unsafe_allow_html=True)
    if st.button("라인업 확인하기", key="go_products", use_container_width=True, type="primary"):
        st.switch_page("pages/products_v0.3.py")
...
with col3:
    ...
    """, unsafe_allow_html=True)
    st.button("업데이트 준비 중", key="c3", disabled=True, use_container_width=True)
